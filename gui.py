...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "FastSegFormer-PyQT"))
        self.pushButton_Model.setText(_translate("Dialog", "文件配置"))
        ...
        self.label.setText(_translate("Dialog", "FastSegFormer-VisionSystem"))
        self.pushButton_BegDet.setText(_translate("Dialog", "开始检测"))
        self.pushButton_StopDet.setText(_translate("Dialog", "停止检测"))
        self.pushButton_SavePath.setText(_translate("Dialog", "保存路径"))
